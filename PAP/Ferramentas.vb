Public Class Ferramentas
    ...
    Private Sub ButtonAbrir1_Click(sender As Object, e As EventArgs) Handles ButtonAbrir1.Click
        ...
        Catch ex As Exception
            MsgBox("Acesso negado pelo utilizador. O nome da ferramenta que pretende abrir foi modificado ou foi alterada a sua localização. Verifique na label 'Ajuda' o local em que está inserido.")
        End Try
    End Sub
